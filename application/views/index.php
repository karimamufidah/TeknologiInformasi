...
<link href="assets/css/footer-pic.css" rel="stylesheet" type="text/css" media="all"/>
<link href="assets/css/jQuery.lightninBox.css" rel="stylesheet" type="text/css" media="all" />
<link href="assets/css/staff.css" rel="stylesheet" type="text/css" media="all"/>
<link href='assets/css/aos.css' rel='stylesheet prefetch' type="text/css" media="all" />
	...
	<div class="container">
		<nav class="navbar navbar-inverse navbar-static-top">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="index.php"><h1>ITS</h1></a>
			</div>
			<div id="navbar" class="navbar-collapse collapse">
				<ul class="nav navbar-nav cl-effect-18">
					<li class="active"><a href="index.php" class="page-scroll" data-hover="Home">Beranda</a></li>
					<li><a href="#about" class="page-scroll" data-hover="About">Visi</a></li>
					<li><a href="#service" class="page-scroll" data-hover="Services">Lulusan</a></li>
					<li><a href="#team" class="page-scroll" data-hover="Team">Fasilitas</a></li>
					<li><a href="#portfolio" class="page-scroll" data-hover="Portfolio">Tentang</a></li>
					<li><a href="#contact" class="page-scroll" data-hover="Contact">Kontak</a></li>
				</ul>
			</div>
...
<section class="info-w3l" id="info" data-aos="zoom-in">
	<div class="col-lg-4 col-md-4 col-sm-12 info-wthree1">
		...
		<div class="col-xs-10">
			<div class="info-agile">
				<h3>SNMPTN</h3>
				<p>Untuk informasi yang lebih lanjut mengenai seleksi masuk jalur Seleksi Nasional Masuk Perguruan Tinggi Negeri (SNMPTN) dapat mengakses <a href="https://smits.its.ac.id/sarjana/#snmptn" target="_blank">link ini</a></p>
			</div>
		</div>
	...
	<div class="col-lg-4 col-md-4 col-sm-12 info-wthree2">
		...
		<div class="col-xs-10">
			<div class="info-agile">
				<h3>SBMPTN</h3>
				<p>Untuk informasi yang lebih lanjut mengenai seleksi masuk jalur Seleksi Bersama Masuk Perguruan Tinggi Negeri (SBMPTN) dapat mengakses <a href="https://smits.its.ac.id/sarjana/#sbmptn" target="_blank">link ini</a></p>
			</div>
		</div>
		<div class="clearfix"></div>
		<hr>
	...
	<div class="col-lg-4 col-md-4 col-sm-12 info-wthree3">
		...
		<div class="col-xs-10">
			<div class="info-agile">
				<h3>PKM</h3>
				<p>Untuk informasi yang lebih lanjut mengenai seleksi masuk ITS Surabaya jalur Program Kemitraan dan Mandiri (PKM) dapat mengakses <a href="https://smits.its.ac.id/sarjana/#pkm" target="_blank">link ini</a></p>
			</div>
		</div>
		<div class="clearfix"></div>
		<hr>
...
<section class="about-agileits" id="about">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-12 about-w3ls2" data-aos="zoom-in">
			<div class="about-w3l">
				<h3><span class="fa fa-diamond" aria-hidden="true"></span>VISI</h3>	
				<p> Menjadi Program Studi Teknologi Informasi yang unggul dalam bidang keamanan siber dan Teknologi berbasis Internet (Internet of Things) untuk mendukung pembangunan Smart City secara berkelanjutan hingga tahun 2022</p>
		...
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title w3-agileits agileits-w3layouts w3layouts">Misi</h4>
				</div>
				<div class="modal-body">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<ol>
                            <li>Menyelenggarakan pendidikan dan pengajaran Teknologi Informasi dengan menggunakan kurikulum yang adaptif, berorientasi ke masa depan dan didukung SDM yang berkualitas serta fasilitas yang memadai
                            </li>
                            <li>Melaksanakan penelitian yang bermutu di bidang Keamanan Siber dan Internet of Things untuk teknologi Smart City
                            </li>
                            <li>Menjalin kemitraan dengan instansi dalam maupun luar negeri
                            </li>
                            <li>Menyelenggarakan pengabdian kepada masyarakat berupa pelatihan, penyuluhan, penerapan hasil penelitian untuk pengembangan potensi dan pemberdayaan masyarakat daerah
                            </li>
                        </ol>
					</div>
					<div class="clearfix"></div>
				...
				<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img1.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img1.jpg" class="img-responsive" alt="w3ls" />
								<div class="b-wrapper">
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img2.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img2.jpg" class="img-responsive" alt="w3ls"/>
								<!-- <div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Teaching</h5>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img3.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img3.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>John McCarthy</h5>
									<p>Pakar Komputasi IT</p>
								</div>
							</a>
						</div>
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img4.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img4.jpg" class="img-responsive" alt="w3ls"/>
								<!-- <div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
					...
					<div class="tab_img">
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img5.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img5.jpg" class="img-responsive" alt="w3ls"/>
								<!-- <div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Learning</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img6.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img6.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Rudiantara</h5>
									<p>Menkominfo</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img7.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img7.jpg" class="img-responsive" alt="w3ls"/>
								<!-- <div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Awards</h5>
									<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet.</p>
						...
						<div class="col-md-3 col-sm-6 col-xs-6 portfolio-grids" data-aos="zoom-in">
							<a href="assets/images/port-img8.jpg" class="b-link-stripe b-animate-go lightninBox" data-lb-group="1">
								<img src="assets/images/port-img8.jpg" class="img-responsive" alt="w3ls"/>
								<div class="b-wrapper">
									<i class="fa fa-search-plus" aria-hidden="true"></i>
									<h5>Bill Gates</h5>
									<p>Microsoft</p>
...
<section class="contact-wthree jarallax" id="contact">
	<div class="container">
		...
		<div class="col-lg-2 col-md-2 col-sm-2" data-aos="zoom-in">
			<img src="assets/images/contact-img1.jpg" alt="" class="img-circle img-responsive">
		</div>
		...
		<div class="col-lg-12" data-aos="zoom-in">
			<ul class="contact-info">
				<li>
					...
					<p class="contact-p2">031 5994251</p>
				</li>
				<li>
					<i class="fa fa-envelope" aria-hidden="true"></i>
					<p class="contact-p1"><a href="mailto:humas@its.ac.id">humas@its.ac.id</a></p>
                    <p class="contact-p2"><a href="mailto:teknologi.informasi@its.id">teknologi.informasi@its.ac.id</a></p>
				</li>
				<li>
					<i class="fa fa-address-book" aria-hidden="true"></i>
					<p class="contact-p1">Jalan Raya ITS</p>
					<p class="contact-p2">Keputih, Sukolilo, Kota SBY</p>
				</li>
			</ul>
		</div>	
		<div class="clearfix"></div>	
...
<script src="assets/js/bgfader.js"></script>
<script>
...
<script src="assets/js/jQuery.lightninBox.js"></script>
<script type="text/javascript">
